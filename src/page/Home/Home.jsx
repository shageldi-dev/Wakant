                ...
                loading?
                    ...
                    <div>
                        <Grid container alignItems={'flex-start'} justifyContent={'space-between'}>
                            <Grid item xs={12} sm={12} md={6}>
                                <Stack spacing={4} direction={'column'} sx={{mt: isMobile ? 5 : 8}}>
                                    ...
                                    >
                                        {
                                            data?data.agencyList.map((item,i)=>{
                                                return(
                                                    <SwiperSlide key={`slide-agency-${i}`}>
                                                        <img alt={'slide-image'}  src={getImageFullUrl(item.imageUrl)} className={'sponsor-image'}/>
                                                    </SwiperSlide>
                                                )
                                            }): null
                                        }
                        ...
                        <Box mt={top}>
                            ...
                            <CategoryContainer list={data?data.bigCategories?data.bigCategories:[]:[]}/>
                        </Box>
                        {/* Category section */}
                                ...
                                <Grid item ref={tJobsRef} xs={12} sm={12} md={6.5}>
                                    <Stack sx={{width: '100%'}} justifyContent={'space-between'}>
                                        <Stack>
                                            ...
                                            <JobsContainer list={data?data.submittedToday?data.submittedToday:[]:[]}/>
