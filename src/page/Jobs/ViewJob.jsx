                    ...
                    <div>
                        <Grid container alignItems={'center'}>
                            <Grid item xs={12} sm={12} md={8}>
                                ...
                                <Bold value={appLanguage==='ru'?data.professionRu:data.profession} sx={{fontSize: '32px'}}/>
                                <Stack direction={'row'} mt={1} spacing={3} alignItems={'center'}>
                                    <Stack direction={'row'} spacing={1} alignItems={'center'}>
                                        <PaidIcon sx={{width: '22px', color: 'custom.notActive'}}/>
                                        <Text value={`${data.salary} TMT`} sx={{fontSize: '16px', color: 'custom.notActive'}}/>
                                    </Stack>

                                    <Stack direction={'row'} spacing={1} alignItems={'center'}>
                                        <AccessTimeFilledIcon sx={{width: '22px', color: 'custom.notActive'}}/>
                                        <Text value={convertTimeStampToDate(data.createdAt)} sx={{fontSize: '16px', color: 'custom.notActive'}}/>
                                    </Stack>
                                </Stack>
                        ...
                        <Grid container spacing={3}>
                            <Grid item xs={12} sm={12} md={8}>
                                <Box sx={{backgroundColor: 'custom.notActiveBlue', borderRadius: '5px', p: 3, mt: 3}}>
                                    ...
                                    <Grid container mt={1} spacing={3}>
                                        <Grid item xs={12} sm={12} md={6}>
                                            <Grid container alignItems={'center'} justifyContent={'space-between'}>
                                                ...
                                                <Grid xs={6}>
                                                    <Text value={appLanguage==='ru'?data.category.nameRu:data.category.name} sx={{
                                                        fontSize: '18px',
                                                        textAlign: 'end',
                                                        wordWrap: 'break-word',
                                            ...
                                            <Grid mt={2} container alignItems={'center'} justifyContent={'space-between'}>
                                                ...
                                                <Grid xs={6}>
                                                    <Text value={`${data.minAge} - ${data.maxAge}`} sx={{
                                                        fontSize: '18px',
                                                        textAlign: 'end',
                                                        wordWrap: 'break-word',
                                                        whiteSpace: '-moz-pre-wrap',
                                            ...
                                            <Grid mt={2} container alignItems={'center'} justifyContent={'space-between'}>
                                                ...
                                                <Grid xs={6}>
                                                    <Text value={`${data.workday_hours}, ${t('job_times_saturday')} ${data.saturday_hours==null?'---':data.saturday_hours}, ${t('job_times_sunday')} ${data.sunday_hours==null?'---':data.sunday_hours}`} sx={{
                                                        fontSize: '18px',
                                                        textAlign: 'end',
                                                        wordWrap: 'break-word',
                                                        whiteSpace: '-moz-pre-wrap',
                                        ...
                                        <Grid item xs={12} sm={12} md={6} sx={{maxWidth: '100%'}}>
                                            <Grid container alignItems={'center'} justifyContent={'space-between'}>
                                                ...
                                                <Grid xs={6}>
                                                    <Text value={`+993 ${data.phone_number}`} sx={{
                                                        fontSize: '18px',
                                                        textAlign: 'end',
                                                        wordWrap: 'break-word',
                                                        whiteSpace: '-moz-pre-wrap',
                                    ...
                                    <Divider color={colors.PRIMARY} sx={{mt: 2}}/>
                                    <Text
                                        value={appLanguage==='ru'?data.conditionsRu:data.conditions} sx={{
                                        mt: 2,
                                        fontSize: '18px',
                                        textAlign: 'start',
                                        wordWrap: 'break-word',
                                ...
                                <Box sx={{backgroundColor: 'custom.notActiveBlue', borderRadius: '5px', p: 3, mt: 3}}>
                                    <Stack spacing={3}>
                                        <Grid container sx={{width: '100%'}}>
                                            ...
                                            <Grid item xs={9.5}>
                                                <SemiBold value={appLanguage==='ru'?data.agenstwo.nameRu:data.agenstwo.name} sx={{fontSize: '18px'}}/>
                                                <Stack direction={'row'} spacing={1} alignItems={'center'}>
                                        ...
                                        <ul>
                                            <li>
                                                <Text
                                                    value={'Адрес: Ашхабад, Копетдагский этрап, улица Сейитназара Сейди, улица Сейитназара Сейди, 4/2.'}
                                                    sx={{fontSize: '16px'}}/>
                                            </li>
                                            <li>
                                                <Text value={`Телефон: ${data.agenstwo.phone_number}`}
                                                      sx={{fontSize: '16px'}}/>
                                            </li>
                                        </ul>
                                    </Stack>
                        ...
                        <Stack direction={'row'} sx={{mb: 3}} alignItems={'center'} justifyContent={'space-between'}>
                            ...
                            <Stack direction={'row'} spacing={2}>
                                ...
                                }} sx={{color: 'custom.textColor', backgroundColor: 'custom.notActiveBlue'}}>
                                    <ArrowBackIcon/>
                                </IconButton>
                                <IconButton onClick={() => {
