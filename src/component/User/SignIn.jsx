...
import {Box, Checkbox, FormControlLabel, IconButton, Modal, Stack, TextField, Typography} from "@mui/material";
import PropsTypes from 'prop-types';
import PersonIcon from '@mui/icons-material/Person';
import {BoldTypography, FontSizes, RegularTypography} from "../Common/MuiComponent";
import {useTranslation} from "react-i18next";
import CloseIcon from '@mui/icons-material/Close';
import {Formik, Form, Field} from 'formik';
import * as Yup from 'yup';
import Button from "@mui/material/Button";
import {AppTextField} from "../Common/AppComponent";
    ...
    function FirstPage() {
        ...
        return (
            <Stack alignItems={'center'} sx={{width: '100%'}} spacing={2}>
                ...
                <PersonIcon color={'primary'} sx={{fontSize: 80}}/>
                <BoldTypography sx={{fontSize: FontSizes.title}}>
                    {t('sign_in_to')}
                </BoldTypography>

                <RegularTypography sx={{fontSize: FontSizes.body, textAlign: 'center'}}>
                    {t('sign_in_desc')}
                </RegularTypography>

                <TextField label={t('your_phone')} type={'phone'} value={phone}
                ...
                <FormControlLabel control={<Checkbox defaultChecked={false}/>} label={t('accept_sign_in')}/>
    ...
    function ConfirmPage() {
        ...
        return (
            <Stack alignItems={'center'} sx={{width: '100%'}} spacing={2}>
                ...
                <LockIcon color={'primary'} sx={{fontSize: 80}}/>
                <BoldTypography sx={{fontSize: FontSizes.title}}>
                    {t('confirm_code')}
                </BoldTypography>
                ...
                <TextField label={t('code')} type={'number'} value={code}
                ...
                <CountdownTimer targetDate={dateTimeAfterThreeDays} click={reSend} />
