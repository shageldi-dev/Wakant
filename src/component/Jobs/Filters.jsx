        ...
        {category.data.map((category, i) => {
          return (
            <FilterCheck
              ...
              key={`filter-${i}`}
              count={0}
              label={appLanguage === "ru" ? category.nameRu : category.name}
            />
          );
        })}
      </Stack>
        ...
        {params.genderList.map((gender, i) => {
          return (
            <FilterCheck
              ...
              key={`gender-${i}`}
              count={0}
              label={appLanguage === "ru" ? gender.nameRu : gender.name}
            />
          );
        })}
      </Stack>
        ...
        {agents.map((agent, i) => {
          return (
            <FilterCheck
              ...
              key={`agent-${i}`}
              count={0}
              label={appLanguage === "ru" ? agent.nameRu : agent.name}
            />
          );
        })}
      </Stack>
