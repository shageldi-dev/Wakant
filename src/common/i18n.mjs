...
const resources = {
  ru: {
    translation: {
      ...
      job_read_2: "Держите мой номер телефона в тайне",
      job_read_3: "Пользователи могут оставлять комментарии",
      add_job_button: "ДОБАВИТЬ УВЕДОМЛЕНИЕ",
      ...
      sign_in_to: "Войти",
      sign_in_desc:
        "Войдя в систему, вы можете размещать свои вакансии и соискателей. Вы можете настроить свой профиль, а также легко работать с данными на своем телефоне.",
      ...
      next: "Следующий",
      accept_sign_in:
        "ВАКАНТ Пользовательское соглашение Авторизуясь, я подтверждаю, что прочитал и принял Пользовательское соглашение.",
